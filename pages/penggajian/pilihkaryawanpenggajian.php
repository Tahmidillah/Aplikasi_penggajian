...
<div id="content" class="row mb-3">
    <div class="col">
        ...
        $no = 1;
        $select_sql = "SELECT K.*, B.nama nama_bagian FROM karyawan K
        ...
        <table class="table bg-white rounded shadow-sm table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col" width="200">0psi</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                    <tr class="align-middle">
                        ...
                        <td>
                            <a href="?page=penggajiantambah&nik=<?php echo $row["nik"] ?>" class="btn btn-success"> <i class="fa fa-arrow-circle-right"></i>
                                Pilih
                            </a>
                        </td>
                    </tr>
